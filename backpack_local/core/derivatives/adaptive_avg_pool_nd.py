...
from backpack_local.utils import ADAPTIVE_AVG_POOL_BUG
...
class AdaptiveAvgPoolNDDerivatives(AvgPoolNDDerivatives):
    ...
    def check_parameters(
        self, module: AdaptiveAvgPool1d | AdaptiveAvgPool2d | AdaptiveAvgPool3d
    ) -> None:
        ...
        if ADAPTIVE_AVG_POOL_BUG and module.input0.is_cuda and (self.N == 3):
            warn(
                ...
                "https://discuss.pytorch.org/t/bug-report-autograd-grad-adaptiveavgpool3d-cuda/124614 "
