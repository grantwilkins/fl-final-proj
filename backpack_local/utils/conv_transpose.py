...
from backpack_local.utils.conv import (
    extract_bias_diagonal as conv_extract_bias_diagonal,
)
...
def unfold_by_conv_transpose(
    input: Tensor, module: ConvTranspose1d | ConvTranspose2d | ConvTranspose3d
) -> Tensor:
