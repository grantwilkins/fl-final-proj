...
from backpack_local.utils import TORCH_VERSION_AT_LEAST_1_13
from backpack_local.utils.conv import get_conv_function
from backpack_local.utils.conv_transpose import (
...
if TORCH_VERSION_AT_LEAST_1_13:
    from backpack_local.utils.conv import _grad_input_padding
else:
...
class ConvTransposeNDDerivatives(BaseParameterDerivatives):
    ...
    def _weight_jac_mat_prod(self, module, g_inp, g_out, mat):
        ...
        einstr = f"ngi{dims_kern}{dims_data},vgio{dims_kern}->vngo{dims_data}"
