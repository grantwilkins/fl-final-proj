...
from backpack_local.extensions.saved_quantities import SavedQuantities
...
class BackpropExtension(ABC):
    ...
    def __get_module_extension(self, module: Module) -> ModuleExtension | None:
    ...
    def get_subsampling(self) -> list[int] | None:
