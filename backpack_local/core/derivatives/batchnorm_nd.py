...
class BatchNormNdDerivatives(BaseParameterDerivatives):
    ...
    def _check_parameters(
        self, module: BatchNorm1d | BatchNorm2d | BatchNorm3d
    ) -> None:
    ...
    def hessian_is_zero(self, module: BatchNorm1d | BatchNorm2d | BatchNorm3d) -> bool:
    ...
    def _get_denominator(self, module: BatchNorm1d | BatchNorm2d | BatchNorm3d) -> int:
    ...
    @staticmethod
    def _get_n_axis(module: BatchNorm1d | BatchNorm2d | BatchNorm3d) -> int:
