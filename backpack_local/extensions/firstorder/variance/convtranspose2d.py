from backpack_local.extensions.firstorder.gradient.convtranspose2d import (
    GradConvTranspose2d,
)
from backpack_local.extensions.firstorder.sum_grad_squared.convtranspose2d import (
    SGSConvTranspose2d,
)
