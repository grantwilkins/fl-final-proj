from backpack_local.extensions.firstorder.gradient.convtranspose1d import (
    GradConvTranspose1d,
)
from backpack_local.extensions.firstorder.sum_grad_squared.convtranspose1d import (
    SGSConvTranspose1d,
)
