...
from backpack_local.utils import conv as convUtils
...
class HBPConvNd(HBPBaseModule):
    ...
    def _factors_from_input(
        self, ext: HBP, module: Conv1d | Conv2d | Conv3d
    ) -> list[Tensor]:
    ...
    def _factor_from_sqrt(
        self, module: Conv1d | Conv2d | Conv3d, backproped: Tensor
    ) -> Tensor:
    ...
    def _maybe_raise_groups_not_implemented_error(
        ext: HBP, module: Conv1d | Conv2d | Conv3d
    ):
