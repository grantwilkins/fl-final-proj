...
from backpack_local.extensions.secondorder.hbp.hbp_options import (
    BackpropStrategy,
    ExpectationApproximation,
)
from backpack_local.extensions.secondorder.hbp.hbpbase import HBPBaseModule
from backpack_local.utils.conv_transpose import unfold_by_conv_transpose

if TYPE_CHECKING:
    from backpack_local.extensions.secondorder.hbp import HBP
...
class HBPConvTransposeNd(HBPBaseModule):
    ...
    def weight(
        self,
        ext: HBP,
        module: ConvTranspose1d | ConvTranspose2d | ConvTranspose3d,
        g_inp: tuple[Tensor],
        g_out: tuple[Tensor],
        backproped: Tensor,
    ) -> list[Tensor]:
    ...
    def _factors_from_input(
        self, ext: HBP, module: ConvTranspose1d | ConvTranspose2d | ConvTranspose3d
    ) -> list[Tensor]:
    ...
    def _maybe_raise_groups_not_implemented_error(
        ext: HBP, module: ConvTranspose1d | ConvTranspose2d | ConvTranspose3d
    ):
